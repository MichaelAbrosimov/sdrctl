...
- **Автор:** Codex
- **Статус:** Реализовано пакетом 5 — ожидает ревью Codex/Michael
...
- **Автор:** Codex
- **Статус:** Закрыто пакетами 1–5 — ожидает финального ревью
...
- **Пакет 5 (P3: SDR-P3-01…04 + видимость карантина) — реализован, ожидает
  ревью.** `KnownFields(true)` (конфиг + secrets) и операционная валидация
